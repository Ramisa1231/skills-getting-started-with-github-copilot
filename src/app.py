...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim laps, learn techniques, and train for swim meets",
    ...
    "Drama Society": {
        "description": "Act in plays, work on stagecraft, and perform for the school",
    ...
    "Science Club": {
        "description": "Conduct experiments, explore scientific concepts, and work on projects",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
